...
static void draw_ascii_char(uint16_t x, uint16_t y, char c, uint16_t color, uint16_t bg_color) {
...
void app_main(void) {
  ...
  while (1) {
    ...
    show_chinese_string(10, 10, "你好世界", RED, WHITE, lcd_draw_pixel, draw_ascii_char);
