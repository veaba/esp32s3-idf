...
ESP32-S3 firmware project (ATK-DNESP32S3 V1.2 dev board) that drives an SPI LCD display with Chinese character (hanzi) rendering. Uses ESP-IDF v5.5.4 build system.
