...
# ==================== 配置参数 ====================
UNICODE_TABLE_FILE = "F:/hardware-design/esp32s3-idf/scripts/3k_chinese_unicode_gen/chinese_3k.txt"
OUTPUT_H_FILE = "chinese16_3k.h"
FONT_SIZE = 16
FONT_PATH = "F:/hardware-design/esp32s3-idf/scripts/3k_chinese_unicode_gen/simhei.ttf"
...
def parse_unicode_table(filename):
    ...
    # 按Unicode排序（二分查找要求）
    chinese_chars.sort(key=lambda x: x[1])
...
def generate_header_file(chinese_chars, output_file, font, font_size=16):
    """
    生成chinese16_3k.h头文件 (ESP-IDF版本，无Arduino依赖)
    """
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        f.write("#ifndef _CHINESE16_3K_H_\n")
        f.write("#define _CHINESE16_3K_H_\n\n")
        ...
        f.write("#endif // _CHINESE16_3K_H_\n")
...
def main():
    ...
    print("\n  使用方法 (ESP-IDF):")
    print("  1. 将 chinese16_3k.h 复制到工程 main 目录")
    print("  2. 在代码中 #include \"chinese16_3k.h\"")
    print("  3. 实现绘制像素的回调函数")
